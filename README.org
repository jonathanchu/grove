...
- =global-grove-mode= only enables =grove-mode= in the *active* profile's files. Notes in your other vaults open as plain org until you switch to their profile.
